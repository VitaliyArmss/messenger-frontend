        ...
        <div className="privacy-policy-container">
            ...
            <section>
                ...
                <p>
                    ...
                    предпринимаемые Подгайских Виталием Алексеевичем (далее —
                    Оператор).
                </p>
                ...
                <p>
                    ...
                    >
                        https://VitaliyArmss.github.io/messenger/
                    </a>.
                </p>
            </section>
            ...
            <section>
                ...
                <p>
                    ...
                    достижении целей обработки или в случае утраты необходимости
                    ...
                    <table className="privacy-table">
                        <tbody>
                            <tr>
                                ...
                                <td>
                                    Обеспечение функционирования учебного проекта — мессенджера, включая регистрацию и
                                    идентификацию пользователей, предоставление
                                    доступа к функционалу сервиса, обеспечение
                                    обмена сообщениями и файлами между
                                    пользователями, а также обеспечение
                            ...
                            <tr>
                                ...
                                <td>
                                    <ul>
                                        ...
                                        <li>фотографии;</li>
                                        <li>содержание сообщений пользователей;</li>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    (предоставление, доступ), удаление и
            ...
            <section>
                ...
                <p>
                    ...
                    самостоятельно, путем направления Оператору уведомления на
                    адрес электронной почты Оператора{' '}
                    <strong>kung-fu.00@mail.ru</strong> с пометкой
                ...
                <p>
                    ...
                    <strong>kung-fu.00@mail.ru</strong> с пометкой «Отзыв согласия
                ...
                <p>
                    ...
                    самостоятельно знакомится с указанными документами.
            ...
            <section>
                ...
                <p>
                    ...
                    электронной почты <strong>kung-fu.00@mail.ru</strong>.
                </p>
                ...
                <p>
                    ...
                    <a
                        ...
                        rel="noopener noreferrer"
                    >
                        https://VitaliyArmss.github.io/messenger/privacy
                    </a>.
                </p>
            </section>
